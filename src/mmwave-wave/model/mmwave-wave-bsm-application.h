...
/**
 * \ingroup wave
 * \brief The MmWaveWaveBsmApplication class sends and receives the
 ...
 */
class MmWaveWaveBsmApplication : public Application
{
public:
  /**
   ...
   * \return none
   */
  MmWaveWaveBsmApplication ();
  virtual ~MmWaveWaveBsmApplication ();
...
private:
  ...
  Ptr<MmWaveWaveBsmStats> m_waveBsmStats; ///< BSM stats
