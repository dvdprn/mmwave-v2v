 ...
 */
#ifndef MMWAVE_WAVE_OCB_WIFI_MAC_H
#define MMWAVE_WAVE_OCB_WIFI_MAC_H
 ...
 */
class MmWaveWaveOcbWifiMac : public RegularWifiMac
{
public:
  /**
  ...
  MmWaveWaveOcbWifiMac (void);
  virtual ~MmWaveWaveOcbWifiMac (void);
  /**
  ...
  /**
   * \param device make current MAC entity associated with MmWaveWaveNetDevice
   *
   * To support MAC extension for multiple channel operation,
   *  WaveMacLow object will be used to replace original MacLow object.
   */
  void EnableForWave (Ptr<MmWaveWaveNetDevice> device);
  /**
   * To support MAC extension for multiple channel operation,
