 ...
 */
#ifndef MMWAVE_WAVE_CHANNEL_COORDINATOR_H
#define MMWAVE_WAVE_CHANNEL_COORDINATOR_H
 ...
 */
class MmWaveWaveChannelCoordinationListener : public SimpleRefCount<MmWaveWaveChannelCoordinationListener>
{
public:
  virtual ~MmWaveWaveChannelCoordinationListener (void);
  /**
...
/**
 * \ingroup wave
 * \brief MmWaveWaveChannelCoordinator deals with channel coordination in data plane (see 1609.4 chapter 5.2)
 *
 *      <------------   -----SYNCI-----------------> <-------------------SYNCI------------------>
 *                   CCHI                      SCHI                         CCHI                     SCHI
 *     |..************|..************|..************|..************|
 ...
 */
class MmWaveWaveChannelCoordinator : public Object
{
public:
  /**
  ...
  MmWaveWaveChannelCoordinator ();
  virtual ~MmWaveWaveChannelCoordinator ();
   ...
   */
  void RegisterListener (Ptr<MmWaveWaveChannelCoordinationListener> listener);
  /**
   * \param listener the current attached listener
   *
   * Remove the specified listener.
   */
  void UnregisterListener (Ptr<MmWaveWaveChannelCoordinationListener> listener);
  /**
...
private:
  ...
  /// Listeners typdef
  typedef std::vector<Ptr<MmWaveWaveChannelCoordinationListener> > Listeners;
  /// Listeners iterator typedef
  typedef std::vector<Ptr<MmWaveWaveChannelCoordinationListener> >::iterator ListenersI;
