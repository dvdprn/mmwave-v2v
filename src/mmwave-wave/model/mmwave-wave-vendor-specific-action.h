 ...
 */
#ifndef MMWAVE_WAVE_Vendor_Specific_Action_H
#define MMWAVE_WAVE_Vendor_Specific_Action_H
...
public:
  ...
  // below methods will be called by MmWaveWaveVendorSpecificActionHeader
  /**
   * Get serialized size
 ...
 *        Octets:       1                j                        Variable
 *
 * In ns-3, VSA frame will be divided into  MmWaveWaveVendorSpecificActionHeader vsaHeader
 ...
 */
class MmWaveWaveVendorSpecificActionHeader : public Header
{
public:
  MmWaveWaveVendorSpecificActionHeader (void);
  virtual ~MmWaveWaveVendorSpecificActionHeader (void);
...
public:
   ...
   * by MmWaveWaveVendorSpecificAction management frame.
