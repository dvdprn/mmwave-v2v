...
NS_LOG_COMPONENT_DEFINE ("MmWaveWaveVendorSpecificAction");
...
/*********** MmWaveWaveVendorSpecificActionHeader *******/
NS_OBJECT_ENSURE_REGISTERED (MmWaveWaveVendorSpecificActionHeader);

MmWaveWaveVendorSpecificActionHeader::MmWaveWaveVendorSpecificActionHeader (void)
  : m_oi (),
...
void
MmWaveWaveVendorSpecificActionHeader::SetOrganizationIdentifier (OrganizationIdentifier oi)
{
...
OrganizationIdentifier
MmWaveWaveVendorSpecificActionHeader::GetOrganizationIdentifier (void) const
{
  NS_LOG_FUNCTION (this);
  return m_oi;
}
...
TypeId
MmWaveWaveVendorSpecificActionHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::MmWaveWaveVendorSpecificActionHeader")
    .SetParent<Header> ()
    .SetGroupName ("MmWave-Wave")
    .AddConstructor<MmWaveWaveVendorSpecificActionHeader> ()
  ;
...
uint8_t
MmWaveWaveVendorSpecificActionHeader::GetCategory (void) const
{
  NS_LOG_FUNCTION (this);
  return m_category;
}
...
TypeId
MmWaveWaveVendorSpecificActionHeader::GetInstanceTypeId (void) const
{
  NS_LOG_FUNCTION (this);
  return GetTypeId ();
}
...
void
MmWaveWaveVendorSpecificActionHeader::Print (std::ostream &os) const
{
  NS_LOG_FUNCTION (this << &os);
  os << "MmWaveWaveVendorSpecificActionHeader[ "
...
uint32_t
MmWaveWaveVendorSpecificActionHeader::GetSerializedSize (void) const
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveWaveVendorSpecificActionHeader::Serialize (Buffer::Iterator start) const
{
  NS_LOG_FUNCTION (this << &start);
...
uint32_t
MmWaveWaveVendorSpecificActionHeader::Deserialize (Buffer::Iterator start)
{
  NS_LOG_FUNCTION (this << &start);
