 ...
 */
#ifndef MMWAVE_WAVE_VSA_MANAGER_H
#define MMWAVE_WAVE_VSA_MANAGER_H
#include <vector>
 ...
 */
class MmWaveWaveVsaManager : public Object
{
public:
  /**
  ...
  MmWaveWaveVsaManager (void);
  virtual ~MmWaveWaveVsaManager (void);

  /**
   * \param device MmWaveWaveNetDevice associated with MmWaveWaveVsaManager
   */
