 ...
 */
#ifndef MMWAVE_WAVE_DEFAULT_CHANNEL_SCHEDULER_H
#define MMWAVE_WAVE_DEFAULT_CHANNEL_SCHEDULER_H

#include "mmwave-wave-net-device.h"
namespace ns3 {
class MmWaveWaveNetDevice;
 ...
 */
class MmWaveWaveDefaultChannelScheduler : public MmWaveWaveChannelScheduler
{
public:
  /**
  ...
  MmWaveWaveDefaultChannelScheduler ();
  virtual ~MmWaveWaveDefaultChannelScheduler ();

  /**
   * \param device enable channel scheduler associated with MmWaveWaveNetDevice
   */
  virtual void SetMmWaveWaveNetDevice (Ptr<MmWaveWaveNetDevice> device);
  /**
...
private:
  ...
  Ptr<MmWaveWaveChannelManager> m_manager; ///< channel manager
  Ptr<MmWaveWaveChannelCoordinator> m_coordinator; ///< channel coordinator
  ...
  Ptr<MmWaveWaveChannelCoordinationListener> m_coordinationListener; ///< coordination listener
};
