 ...
 */
#ifndef MMWAVE_WAVE_CHANNEL_SCHEDULER_H
#define MMWAVE_WAVE_CHANNEL_SCHEDULER_H
 ...
 */
class MmWaveWaveChannelScheduler : public Object
{
public:
  /**
  ...
  MmWaveWaveChannelScheduler ();
  virtual ~MmWaveWaveChannelScheduler ();
...
protected:
  ...
  Ptr<MmWaveWaveNetDevice> m_device; ///< the device
};
