 ...
 */
#ifndef MMWAVE_WAVE_MAC_LOW_H
#define MMWAVE_WAVE_MAC_LOW_H
 ...
 */
class MmWaveWaveMacLow : public MacLow
{
public:
  /**
  ...
  MmWaveWaveMacLow ();
  virtual ~MmWaveWaveMacLow ();

  /**
   * \param device MmWaveWaveNetDevice associated with MmWaveWaveMacLow
   */
  void SetMmWaveWaveNetDevice (Ptr<MmWaveWaveNetDevice> device);
...
private:
  ...
  Ptr<MmWaveWaveChannelScheduler> m_scheduler; ///< the channel scheduler
  Ptr<MmWaveWaveChannelCoordinator> m_coordinator; ///< the channel coordinator
};
