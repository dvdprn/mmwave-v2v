 ...
 */
#ifndef MMWAVE_WAVE_HIGHER_LAYER_TX_VECTOR_TAG_H
#define MMWAVE_WAVE_HIGHER_LAYER_TX_VECTOR_TAG_H
 ...
 */
class MmWaveWaveHigherLayerTxVectorTag : public Tag
{
public:
  /**
  ...
  MmWaveWaveHigherLayerTxVectorTag (void);
  /**
   * Constructor
   *
   ...
   */
  MmWaveWaveHigherLayerTxVectorTag (WifiTxVector txVector, bool adaptable);
  /**
