...
#ifndef MMWAVE_WAVE_BSM_STATS_H
#define MMWAVE_WAVE_BSM_STATS_H
...
/**
 * \ingroup wave
 * \brief The MmWaveWaveBsmStats class implements a stats collector for
 ...
 */
class MmWaveWaveBsmStats : public Object
{
public:
  /**
   * \brief Constructor
