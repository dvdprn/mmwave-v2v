...
#ifndef MMWAVE_WAVE_HELPER_H
#define MMWAVE_WAVE_HELPER_H
...
/**
 * \ingroup wave
 * \brief helps to create MmWaveWaveNetDevice objects
 *
 * This class can help to create a large set of similar
 * MmWaveWaveNetDevice objects and to configure a large set of
 * their attributes during creation.
 *
 * Generally MmWaveWaveHelper with default configuration will
 ...
 * MmWaveWaveHelper helper = MmWaveWaveHelper::Default ();
 ...
 * MmWaveWaveHelper helper = MmWaveWaveHelper::Default ();
 * helper.helper.CreateMacForChannel (MmWaveWaveChannelManager::GetWaveChannels ());
 ...
 */
class MmWaveWaveHelper
{
public:
  MmWaveWaveHelper ();
  virtual ~MmWaveWaveHelper ();

  /**
   * \returns a new MmWaveWaveHelper in a default state
   *
   ...
   */
  static MmWaveWaveHelper Default (void);
  ...
  *          MmWaveWaveNetDevice should be modified to use fixed streams
