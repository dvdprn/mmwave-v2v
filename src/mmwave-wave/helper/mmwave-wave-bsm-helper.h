...
#ifndef MMWAVE_WAVE_BSM_HELPER_H
#define MMWAVE_WAVE_BSM_HELPER_H
...
/**
 * \ingroup wave
 * \brief The MmWaveWaveBsmHelper class manages
 * IEEE 1609 WAVE (Wireless Access in Vehicular Environments)
 * Basic Safety Messages (BSMs) and uses the MmWaveWaveBsmStats class
...
public:
  ...
  /**
   * \brief Returns the MmWaveWaveBsmStats instance
   * \return the MmWaveWaveBsmStats instance
   */
  Ptr<MmWaveWaveBsmStats> GetMmWaveWaveBsmStats ();
...
private:
  ...
  MmWaveWaveBsmStats m_waveBsmStats; ///< wave BSM stats
