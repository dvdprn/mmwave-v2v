 ...
 */
#ifndef MMWAVE_WIFI_802_11P_HELPER_H
#define MMWAVE_WIFI_802_11P_HELPER_H
 ...
 */
class MmWaveWifi80211pHelper : public WifiHelper
{
public:
  MmWaveWifi80211pHelper ();
  virtual ~MmWaveWifi80211pHelper ();

  /**
   * \returns a new MmWaveWifi80211pHelper in a default state
   *
   ...
   */
  static MmWaveWifi80211pHelper Default (void);
